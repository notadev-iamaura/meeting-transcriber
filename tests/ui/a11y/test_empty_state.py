...
def test_empty_state_no_axe_violations(page: Page) -> None:
    ...
    color-contrast 룰 재활성화 완료 (T-102 dark-mode-tones 에서 라이트
    토큰 보강 후). 라이트 모드 `--text-secondary` 는 #6E6E73 (5.07:1) 로
    AA 4.5:1 통과, `--text-muted` 는 #8E8E93 (3.26:1) 로 UI 1.4.11 3:1 통과.
    참조: docs/superpowers/ui-ux-overhaul/wave-1/dark-mode-tones-mockup.md §4
    """
