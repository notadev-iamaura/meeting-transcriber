...
5. 식별 불가하면 빈 배열 [].
6. citations 의 timestamp_str 은 반드시 발화 목록에 있는 실제 시각을 사용.
7. 00:00:00 은 발화 목록에 실제로 [00:00:00] 줄이 있을 때만 사용하고, 추정 기본값으로 쓰지 말 것.
"""
...
5. confidence 마커 <!-- confidence: N --> 누락 금지.
6. 외국어 병기 금지.
"""
...
4. 00:00:00 은 발화 목록에 실제로 [00:00:00] 줄이 있을 때만 사용하고, 추정 기본값으로 쓰지 마세요.
5. 외국어 병기 금지.
"""
