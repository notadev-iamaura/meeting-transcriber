# ✅ RESOLVED — STT 모델 선택기 — 아키텍처 & TDD 구현 계획

> **상태 (2026-04-26)**: 모델 선택기 기능은 운영 중. 등록 모델은 4종으로 확장됨
> (large-v3-turbo / komixv2 / seastar-medium-4bit / ghost613-turbo-4bit).
> 기본·추천 = `large-v3-turbo` (PR #18).
> 본 문서는 초기 설계 기록 보존용.
